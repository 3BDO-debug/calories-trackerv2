...
import axiosInstance, { mainUrl } from "./config";

export const signupRequest = async (requestData) =>
  axiosInstance({
    method: "post",
    url: "/accounts/signup",
    data: requestData,
...
export const inviteFriendRequest = async (requestData) =>
  axiosInstance({
    method: "post",
    url: "/accounts/invite-friend",
    data: requestData,
  }).then((response) => response.data);
